...
describe('#breedDetails', () => {
  ...
  it('returns undefined for a breed of cat that is not documented', () => {
    const expectedDesc = undefined;

    const germanShepherd = breedDetails('German Shepherd');
    assert.equal(expectedDesc, germanShepherd);
  });
});
